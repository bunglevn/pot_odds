...
export const OnePair = ({ numCard }) => {
  ...
  if (numCard === 6) return (
      <>
          <Typography>
              However, because there is only 1 card left from the River, the only possible hand that you can aim for is <span className="text-sky-500 font-bold"> Three of a kind.
          </span>
          </Typography>
          <StaticMathField>
